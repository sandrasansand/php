...
<?php
$con = conectar_db();
define('BASE_URL', 'http://localhost/clase/tienda/');

// minuto 16 eb adelante http://db738041399.db.1and1.com/dbo738041399
...
<form id="form1" name="form1" method="post" action="">
	...
	<table width="200" border="0" algin="left">
		...
		<tr>
			...
			<td><input type="submit" name="submit" id="submit" value="aceptar">
				</form></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<!-- 	      <td align="center" bgcolor="#E4D0F4">EDITAR</td> 
	      <td align="center" bgcolor="#E4D0F4">BORRAR</td> AÃ‘ADIR 2 COL MÃ�S -->
		</tr>
		  <?php
    ...
    while ($filas = mysqli_fetch_array($resultado)) { // recorremos y nos guardamos todos los campos de la base, cada uno en una variable
        ...
        // mas abajo se entrarÃ¡ o no en modo ediciÃ³n o en modo normal comprar , dependiendo de la variable $modo que le pasamos a la funcion
			...
			<td bgcolor="#FBFBEF">
				<form id="compra" name="compra" method="post" action="carrito.php">
					<input type="hidden" name="id_txt" value="<?php echo $id ?>" /> <input
						...
						type="hidden" name="cantidad" value="1" /> <input type="submit"
			...
			<td bgcolor="#FBFBEF">
				...
				<form id="compra" name="compra" method="post" action="editar.php">
					<input type="hidden" name="id2" value="<?php echo $id ?>" /> <input
						...
						type="submit" name="comprar" value="editar" />
				</form>

				<form action="borrar.php" method="post">
					<input type="hidden" name="id" value="<?php echo $id ?>" />
					<!-- el value corresponde al articulo almacenado en $id,por post -->
					<input type="submit" name="" value="Borrar" />
					<!--   enviamos el id almacenado en name que va a borrar.-->
				</form>
...
// MEJORAR ESTA FUNCIÃ“N CUANDO BORRO NO BORRA EN CASCADA Y ACTUALIZA .... MIRAR
